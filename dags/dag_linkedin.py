...
with DAG(
    ...
    run_script = KubernetesPodOperator(
        ...
        cmds=["/bin/bash", "-c"],
        arguments=["source /mnt/data/airflow/venv/bin/activate && /mnt/data/airflow/venv/bin/pip install -U jobspy && cd /mnt/data/airflow/ && /mnt/data/airflow/venv/bin/python /mnt/data/airflow/linkedin_scraper/main.py"],
